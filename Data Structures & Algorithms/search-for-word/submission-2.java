class Solution {
    ...
    public boolean dfs(char[][] board, String word, int i, int j, Set<String> visited) {
            ...
            visited.add(i+","+j);
            boolean res = dfs(board, word.substring(1), i + 1, j, visited) || dfs(board, word.substring(1), i - 1, j, visited) || dfs(board, word.substring(1), i, j + 1, visited) || dfs(board, word.substring(1), i, j - 1, visited);
